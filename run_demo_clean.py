#!/usr/bin/env python
"""Run the quick arrangement demo with clean output"""
import sys
import time
...
def main():
    ...
    try:
        ...
        # Step 2b - Load instruments
        print("[2/7] Loading instruments (this may take 60 seconds)...")
        for i, uri in enumerate(INSTRUMENTS):
            print(f"  Loading instrument on track {i}...")
        ...
        print("    * Track 0: Drums (one_drop pattern)")
        print("    * Track 1: Bass (E1 notes)")
        print("    * Track 2: Chords (C minor 7)")
        print("    * Track 3: Lead (simple melody)")
        print("=" * 70)
