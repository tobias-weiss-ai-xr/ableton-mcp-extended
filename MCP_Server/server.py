    ...
    def send_command(
        ...
        def _do_send() -> Dict[str, Any]:
            ...
            try:
                ...
                if "scene" in cmd_type or "record" in cmd_type or "capture" in cmd_type:
                    timeout = 60.0  # Longer timeout for operations that involve real-time recording
                else:
...
from MCP_Server.arrangement_tools import register_arrangement_tools
from MCP_Server.optimization_tools import register_optimization_tools
...
register_arrangement_tools(mcp, get_ableton_connection)
register_optimization_tools(mcp, get_ableton_connection)
