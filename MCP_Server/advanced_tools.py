...
def register_generation_tools(mcp: FastMCP, get_ableton_connection):
        ...
        try:
            ...
            if complexity == "simple":
                ...
                for bar in range(int(length_beats / 4)):
                    ...
                    for i, deg in enumerate(degrees):
                        pos = bar * 4 + i + shift
                        pitch = scale.degree_to_midi(deg, octave_offset=1 + (bar % 2))
    ...
    def apply_scene_transition(
        ...
        duration_beats: float = 16.0,
        steps: int = 16,
        wash_device_indices: Optional[list] = None,
        wash_param_reverb: int = 8,
        wash_param_delay: int = 6,
        reverb_track_indices: Optional[list] = None,
    ) -> str:
        """
    ...
    def apply_hypnotic_groove(
        ...
        track_index: int,
        device_index: int,
        parameter_indices: Optional[list] = None,
    ...
    def apply_arrangement_sequence(
        ctx: Context,
        scene_transitions: Optional[list] = None,
